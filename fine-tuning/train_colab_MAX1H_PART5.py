...
MAX QUALITÉ EN 1H — PARTIE 5 (samples 12000-15000)
"""
...
OUTPUT_DIR = "/content/whisper-wolof-max-p5"
...
print(f"\n{'='*60}")
print(f"   TRAINING WOLOF — MAX 1H — PARTIE 5")
print(f"   Samples 12000-15000")
...
print("\nTéléchargement dataset (samples 12000-15000)...")
train_ds = load_dataset("soynade-research/Wolof-ASR-Data", split="train[12000:15000]")
...
print("Bonus: galsenai/wolof_tts (samples 8000-10000)...")
try:
    galsen = load_dataset("galsenai/wolof_tts", split="train[8000:10000]")
...
print(f"\n{'='*60}")
print(f"   ENTRAINEMENT MAX — PARTIE 5 (samples 12000-15000)")
...
FINAL_DIR = "/content/whisper-wolof-final-p5"
trainer.save_model(FINAL_DIR)
processor.save_pretrained(FINAL_DIR)
tokenizer.save_pretrained(FINAL_DIR)

print(f"\n{'='*60}")
print(f"   TERMINÉ — PARTIE 5 !")
print(f"   WER: {results['eval_wer']:.1f}%")
print(f"{'='*60}")

import shutil
shutil.make_archive("/content/whisper-wolof-model-p5", "zip", FINAL_DIR)
from google.colab import files
print("\n>>> Téléchargement du modèle PARTIE 5... <<<")
files.download("/content/whisper-wolof-model-p5.zip")
