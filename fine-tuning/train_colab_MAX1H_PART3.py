...
MAX QUALITÉ EN 1H — PARTIE 3 (samples 6000-9000)
"""
...
OUTPUT_DIR = "/content/whisper-wolof-max-p3"
...
print(f"\n{'='*60}")
print(f"   TRAINING WOLOF — MAX 1H — PARTIE 3")
print(f"   Samples 6000-9000")
...
print("\nTéléchargement dataset (samples 6000-9000)...")
train_ds = load_dataset("soynade-research/Wolof-ASR-Data", split="train[6000:9000]")
...
print("Bonus: galsenai/wolof_tts (samples 4000-6000)...")
try:
    galsen = load_dataset("galsenai/wolof_tts", split="train[4000:6000]")
...
print(f"\n{'='*60}")
print(f"   ENTRAINEMENT MAX — PARTIE 3 (samples 6000-9000)")
...
FINAL_DIR = "/content/whisper-wolof-final-p3"
trainer.save_model(FINAL_DIR)
processor.save_pretrained(FINAL_DIR)
tokenizer.save_pretrained(FINAL_DIR)

print(f"\n{'='*60}")
print(f"   TERMINÉ — PARTIE 3 !")
print(f"   WER: {results['eval_wer']:.1f}%")
print(f"{'='*60}")

import shutil
shutil.make_archive("/content/whisper-wolof-model-p3", "zip", FINAL_DIR)
from google.colab import files
print("\n>>> Téléchargement du modèle PARTIE 3... <<<")
files.download("/content/whisper-wolof-model-p3.zip")
